...
- Ataques y contramedidas en sistemas personales:
  ...
  - Consideraciones de seguridad en el particionado de discos.
    ...
    * https://github.com/jesusninoc/ClasesSOM/blob/master/2019-03-05.md#manage-linux-disk-partitions
    * https://wiki.archlinux.org/index.php/Fstab_(Espa%C3%B1ol)
    * https://github.com/jesusninoc/ClasesSOM/blob/master/2019-03-05.md#copiar-informaci%C3%B3n-en-un-disco-con-bitlocker-y-quitar-el-disco-todo-mediante-cmdlets
